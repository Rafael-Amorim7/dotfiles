...
" set modeline
" set modelines=10
set scrolloff=30       " keep 20 lines visible above and below cursor at all times                                                                        
...
colorscheme PaperColor "dracula, gruvbox-material, gruvbox, nord, PaperColor 
...
" Yank to Vim + OS clipboard by installing xclip https://ubuntu.pkgs.org/20.04/ubuntu-universe-amd64/xclip_0.13-1_amd64.deb.html
  ...
  " EXIT vim
  nnoremap <silent><leader><leader>e :q!<cr>
